 ...
 *
 * authorId enables smart cache invalidation on the client: when a pixel
 ...
 */
public record PixelBroadcast(int x, int y, String color, String authorId, boolean erased) {
}
